...
dashboard.section.buttons.val = {
	...
	dashboard.button("F", " Find files in ~", ":Telescope find_files cwd=~/. <CR>"),
...
if os == "Windows_NT" then
	--dashboard.section.buttons.val[7] = dashboard.button("c", " Edit nvim configs", ":e ~/AppData/Local/nvim/ <CR>")
	dashboard.section.buttons.val[7] =
